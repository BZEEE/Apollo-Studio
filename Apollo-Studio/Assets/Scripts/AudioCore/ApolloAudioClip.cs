...
using AudioClipLoadTypeEnumNS;
using AudioClipCompressionFormatEnumNS;
using AudioClipSampleRateSettingEnumNS;

namespace ApolloAudioClipNS {
    ...
    private ApolloAudioClip audioClip;
